/**
 * docConfigs.js — OCR document type configs
 *
 * প্রতিটি doc type-এর detect pattern + field regex rules।
 * নতুন document type যোগ করতে শুধু এই array-তে config যোগ করলেই হবে।
 *
 * P: শেয়ার্ড regex patterns — একাধিক doc type-এ পুনরায় ব্যবহৃত
 */
